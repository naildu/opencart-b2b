...
class ControllerAccountOrder extends Controller {
	...
	public function index() {
		...
		foreach ($results as $result) {
			...
			$result['date_added'] = $this->model_account_order->getOrderStatusAddedTime($result['order_id'], "Processing");
			$result['date_shipped'] = $this->model_account_order->getOrderStatusAddedTime($result['order_id'], "Shipped");
			...
			$data['orders'][] = array(
				...
				'date_shipped' => $result['date_shipped'] ? date($this->language->get('datetime_format'), strtotime($result['date_shipped'])) : "",
		...
		if($order_total > 0)
			...
			$data['heading_title'] = $this->language->get('no_order_heading_title');
	...
	public function info() {
		...
		if ($order_info['order_status_id'] <= 2) { //<= 2 means 'Processing' or Inquiring
		...
		if ($order_info) {
			...
			$data['text_date_shipped'] = $this->language->get('text_date_shipped');
			...
			$data['date_added'] = $this->model_account_order->getOrderStatusAddedTime($data['order_id'], "Processing");
			$data['date_shipped'] = $this->model_account_order->getOrderStatusAddedTime($data['order_id'], "Shipped");
