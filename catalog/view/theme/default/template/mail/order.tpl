...
<div style="width: 680px;">
  <p style="margin-top: 0px; margin-bottom: 20px;"><?php echo $text_appellation; ?></p>
  <p style="margin-top: 0px; margin-bottom: 20px;"><?php echo $text_greeting; ?></p>
  <?php if ($customer_id && $order_status != "Inquiring" && $order_status != "Processing") { ?>
  ...
  <p style="margin-top: 0px; margin-bottom: 20px;">Best Regards<br><?php echo $text_inscribe; ?></p>
</div>
</body>
</html>
