...
class ModelAccountCustomer extends Model {
	public function addCustomer($data) {
		...
		$message = $this->language->get('text_appellation') . "\n\n";
		...
		$message .= $this->language->get('text_reply') . "\n\n";
		$message .= "Best Regards\n" . sprintf($this->language->get('text_inscribe'), html_entity_decode($this->config->get('config_name'), ENT_QUOTES, 'UTF-8'));
