      ...
      <div class="panel-body">
        <form class="form-horizontal">
          <ul id="order" class="nav nav-tabs nav-justified">
            ...
            <li class="disabled" style="display:none"><a href="#tab-payment" data-toggle="tab">3. <?php echo $tab_payment; ?></a></li>
            <li class="disabled" style="display:none"><a href="#tab-shipping" data-toggle="tab">4. <?php echo $tab_shipping; ?></a></li>
                  ...
                  <tbody id="cart">
                    ...
                    <tr>
                      ...
                      <td class="text-right"><?php echo $order_product['price']; ?>
                        <input type="hidden" name="product[<?php echo $product_row; ?>][price]" value="<?php echo $order_product['price']; ?>" />
                      </td>
...
$('#button-refresh').on('click', function() {
	$.ajax({
		...
		success: function(json) {
          ...
          html += '  <td class="text-right"><div class="input-group btn-block" style="max-width: 200px;"><input type="text" name="product[' + i + '][price]" value="' + product['price'].substr(1) + '" class="form-control" /><span class="input-group-btn"><button type="button" data-toggle="tooltip" title="<?php echo $button_refresh; ?>" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><i class="fa fa-refresh"></i></button></span></div></td>';
